...
export function Education() {
  const education = [
    {
      degree: 'Bachelor of Computer Science (Human-Computer Interaction)',
      ...
      achievements: [
        ...
        'Best HCI Project Award 2024',
        'Member of UTeM Tech Society',
        'Active participant in UI/UX workshops',
      ],
      color: 'from-blue-500 to-cyan-500',
    },
    {
      degree: 'Foundation in Computer Science',
      institution: 'UTeM Preparatory Centre',
      period: '2021 - 2022',
      cgpa: '3.9',
      status: 'Completed',
      achievements: [
        'Excellent achievement in all subjects',
        'Top 5 in programming course',
        'Leadership role in student committee',
      ],
      color: 'from-purple-500 to-pink-500',
    },
    {
      degree: 'SPM (Sijil Pelajaran Malaysia)',
      institution: 'SMK Example School',
      period: '2019 - 2020',
      cgpa: '8A+ 1A',
      status: 'Completed',
      achievements: [
        'Straight A\'s in Science subjects',
        'School ICT club president',
        'National-level Science competition participant',
      ],
