        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="aspect-[4/3] rounded-3xl bg-gradient-to-br from-blue-500/20 via-cyan-500/20 to-purple-500/20 border border-white/10 overflow-hidden backdrop-blur-xl relative">
                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-8xl mb-6">🚀</div>
                    <div className="text-2xl font-bold text-white mb-2">Driven by Innovation</div>
                    <div className="text-slate-300">Creating the future, one design at a time</div>
                  </div>
                </div>
              </div>
